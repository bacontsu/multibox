	...
	public partial class Autofarm : Form {
		...
		private void ToggleMultiboxes(object sender, EventArgs e) {
			...
			if (toggleMultiboxBool) {
				System.Windows.Forms.MessageBox.Show("Multibox Already Turned On");
			} else {
				HookListener();
				button2.Text = "Status : On";
				toggleMultiboxBool = true;
			}
		}
		...
		*/
        ...
        private void button3_Click(object sender, EventArgs e)
        {
			...
			{
				UnhookListener();
				button2.Text = "Status : Off";
				toggleMultiboxBool = false;
				Application.Restart();
			}
			else
			{
				
				System.Windows.Forms.MessageBox.Show("Multibox Already Turned Off");
			}
		}
		...
		private void Autofarm_KeyDown(object sender, KeyEventArgs e)
        {
			if (e.Control == true && e.KeyCode == Keys.J)
            {
				toggleMultibox.PerformClick();
            }
        ...
        {
			System.Windows.Forms.MessageBox.Show("Growtopia Multibox Program Written in Pure C# using \nGlobal-Low-Level-Key-Board-And-Mouse-Hook \n\n\n\nBased on C# Project made by github.com/Blacklock \nFixed by github.com/Bacontsu ");
		}

        private void btn_help_Click(object sender, EventArgs e)
        {
			System.Windows.Forms.MessageBox.Show("You have to run as administrator to enable this application to clone growtopia and perform multiboxing, you dont need to turn off any kind of antivirus because this isnt a virus. This thing uses Global-Low-Level-Key-Board-And-Mouse-Hook that makes it looks kinda suspicious by some virus detector website. \n\n----------<How to use>----------------------------------------------- \n1. Run this Program As Administrator\n2. Select the Location of Growtopia\n3. Press Ctrl + J to Turn on Multiboxing\n4. Use an External Autoclicker (I recommend Official RPG Autoclicker on github because the application is not made for growtopia, therefore there will be no save.dat stealer that is intentionally put in it) \n5. Press Ctrl + K to Turn off Multiboxing\n\n\n----------<REMINDER>------------------------------------------------ \nYOU CANNOT USE YOUR MOUSE OUTSIDE OF GROWTOPIA UNTIL YOU USE ALT + TAB \n\nThanks for using my Program");
